...
class PolynomTest {
	...
	void testPolynomString() {
		double _coefficient1 = 5003.5 ;
		int _pow1 = (int)(Math.random()*10) +24 ;
		
		double _coefficient2 = 42.7 ;
		int _pow2 = (int)(Math.random()*10) + 13 ;
		
		double _coefficient3 = 3.2 ;
		int _pow3 = (int)(Math.random()*10) + 2;
		
		String ans = "" + _coefficient1 + "x^" + _pow1 + " + " + 
		_coefficient2 + "x^" + _pow2 + " + " + _coefficient3 + "x^" + _pow3 ;
		...
		Polynom p1=new Polynom("(2x^2-4)*(-1.2x-7.1)");
		if(!p1.toString().equals("-2.4x^3 - 14.2x^2 + 4.8x + 28.4"))
			fail("Eror , uncorrect constractor");
	}
